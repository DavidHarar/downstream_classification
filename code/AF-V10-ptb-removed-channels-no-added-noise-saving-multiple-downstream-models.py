...
seed = 123
np.random.seed(123)
if args.num_channels_to_turn_off:
    seeds = np.random.randint(0,1000, 8) # I have 7 in the folder already
else:
...
for seed_ in seeds:
    config = {   
        ...
        # misc
        'model_saving_path': f'./models/AF-V10-different-seeds-ptb-{args.num_channels_to_turn_off}_channels_turned_off-saving-downstream-models',
        'verbosity':True,
    ...
    config['model_saving_path']= f'./models/AF-V10-different-seeds-ptb-{args.num_channels_to_turn_off}_channels_off-saving-downstream-models'
